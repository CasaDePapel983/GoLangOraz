...
func main() {
	...
	flag.StringVar(&cfg.smtp.username, "smtp-username", "1cf9454eff2553", "SMTP username")
	flag.StringVar(&cfg.smtp.password, "smtp-password", "75348f4cf14b6b", "SMTP password")
	flag.StringVar(&cfg.smtp.sender, "smtp-sender", "211727@astanait.edu.kz", "SMTP sender")
	flag.Parse()
